...
class TransaksiController extends Controller
{
    ...
    //             $transaksi = Transaksi::where('id_pegawai', Auth::user()->id)->where('tanggal_transaksi', Carbon::now()->format('Y-m-d'))->where('jenis_transaksi','Beli')->orderBy('updated_at','DESC')->get();
    //             $count = Transaksi::where('id_pegawai', Auth::user()->id)->where('tanggal_transaksi', Carbon::now()->format('Y-m-d'))->where('jenis_transaksi','Beli')->count();
    //             $today =  Carbon::now()->format('Y-m-d');
    //             $total_transaksi = Transaksi::where('id_pegawai', Auth::user()->id)->where('tanggal_transaksi', Carbon::now()->format('Y-m-d'))->where('jenis_transaksi','Beli')->sum('total');
    ...
    //         }else{
    //             $transaksi = Transaksi::with('Pegawai')->where('tanggal_transaksi', Carbon::now()->format('Y-m-d'))->where('jenis_transaksi','Beli')->orderBy('updated_at', 'DESC')->get();
    //             $count = Transaksi::where('tanggal_transaksi', Carbon::now()->format('Y-m-d'))->where('jenis_transaksi','Beli')->count();
    //             $today =  Carbon::now()->format('Y-m-d');
    //             $total_transaksi = Transaksi::where('tanggal_transaksi', Carbon::now()->format('Y-m-d'))->where('jenis_transaksi','Beli')->sum('total');
    //             $currency = MasterCurrency::orderBy('jenis_kurs','ASC')->get();
    ...
    //             ->where('tb_currency.deleted_at', 'null')
