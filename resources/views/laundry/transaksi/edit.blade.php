            ...
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body pt-1">
                        <input type="hidden" value="{{ $id_transaksi }}" id="transaksi_id">
                        <div class="col-12 mt-2">
                            ...
                            <input class="form-control form-select-sm"
                                name="tanggal" type="date" placeholder="Input Tanggal Transaksi" value="{{ $tgl }}"
                                required />
                        </div>
                        <div class="col-12 mt-2">
                            ...
                            <select class="form-select form-select-sm" id="jenisCustomer" size="1"
                                ...
                                <option value="{{ $tr->Jenis->id_category_penerima }}">{{ $tr->Jenis->nama_kategori_penerima }}</option>
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <input class="form-control form-select-sm"
                                ...
                                value="{{ $tr->nama_customer }}" required />
                        </div>
                        <div class="col-12 mt-2">
                            <label class="form-label" for="nomor_telephone">Nomor Telephone</label>
                            <input class="form-control form-select-sm "
                                name="nomor_telephone" type="number" value="{{ $tr->nomor_telephone }}"
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <textarea class="form-control form-select-sm "
                                name="alamat" type="text" value="{{ $tr->alamat }}" id="alamat"
                                placeholder="Input Alamat Customer" rows="4">{{ $tr->alamat }}</textarea>
                        </div>
                    </div>
                ...
                <div class="card">
                                ...
                                <table id="dataTableKonfirmasi" class="table table-striped" style="width:100%">
                                    ...
                                    <tbody id="konfirmasi">
                                        ...
                                        <tr id="item-{{ $item->id_detail_transaksi }}" role="row" class="odd">
                                            <td></td>
                                            <td class="type_edit">
                                                <span id="{{ $item->Type->id_type }}">{{ $item->Type->nama_type }}</span>
                                            </td>
                                            <td class="harga_edit">
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="fw-bold berat_total" id="berat_total">{{ $tr->total_berat }} KG</div>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between mt-2">
                            <div class="fw-semi-bold fs--1">Total Dibayarkan</div>
                            <div class="fw-bold payable_total" id="payable_total">Rp&nbsp;{{ number_format($item->total, 0, ',', '.') }}</div>
                        </div>
                    </div>
    ...
    function simpanData(event) {
        ...
        if (jenis == "Pilih Jenis Terlebih Dahulu") {
            ...
            if (dataform2.length == 0) {
                ...
                $.ajax({
                    method: 'put',
                    url: '/transaksi-laundry/' + transaksi_id,
                    data: data,
                    beforeSend: function () {
                        $('#btnSimpan').prop('disabled', true);
                    },
                    success: function (response) {
                        window.location.href = '/transaksi-laundry'
                        // window.open(
                        //     '/cetak/' + id_transaksi,
                        //     '_blank'
                        // );
