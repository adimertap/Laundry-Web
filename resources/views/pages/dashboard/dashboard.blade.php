        ...
        <div class="col-xxl-8">
                        ...
                        <div class="position-relative z-index-2">
                            ...
                            <div class="d-flex py-3">
                                ...
                                <div class="ps-3">
                                    ...
                                    <h4 class="text-800 mb-0">Rp.
                                        {{ number_format($pegawai_laundry_today_total, 0, ',', '.') }}</h4>
                                </div>
                            </div>
                            @endif
            ...
            <div class="mb-3">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="fs--1 bg-light" style="width: 1000px; margin-left:20px">
                        <a class="notification p-0" href="{{ route('transaksi-laundry.create') }}">
                            <div class="notification-body p-3">
            ...
            <div class="card py-3 mb-3">
                <div class="card-body py-3">
                    <div class="row g-0">
                        ...
                        <div
                            class="col-6 col-md-4 border-200 border-md-200 border-bottom border-md-bottom-0 border-md-end pt-4 pb-md-0 ps-3 ps-md-0">
                            <h6 class="pb-1 text-700">Transaksi Laundry Anda Hari Ini</h6>
                            <p class="font-sans-serif lh-1 mb-1 fs-2">{{ $pegawai_count_laundry_today, 0, ',', '.' }}
                            </p>
                            <div class="d-flex align-items-center">
                                <h6 class="fs--1 text-500 mb-0">Transaksi</h6>
                                </h6>
                        ...
                        <div class="col-6 col-md-4 border-200 border-md-bottom-0 border-end pt-4 pb-md-0 ps-md-3">
                            <h6 class="pb-1 text-700">Total Transaksi Laundry Anda Hari Ini </h6>
                            <p class="font-sans-serif lh-1 mb-1 fs-2">Rp. {{ number_format($pegawai_laundry_today_total, 0, ',',
                                '.') }}</p>
                            <div class="d-flex align-items-center">
                                <h6 class="fs--1 text-500 mb-0">Hari Ini</h6>
                            </div>
                        ...
                        <div class="col-6 col-md-4 pb-0 pt-4 ps-3">
                            <h6 class="pb-1 text-700">Total Transaksi Laundry Anda Bulan Ini</h6>
                            <p class="font-sans-serif lh-1 mb-1 fs-2">Rp. {{ number_format($pegawai_sum_laundry_bulan, 0,
                                ',', '.') }}</p>
                            <div class="d-flex align-items-center">
                                <h6 class="fs--1 text-500 mb-0">Bulan Ini: {{ $bulan_ini }}</h6>
                            </div>
        ...
        <div class="col-xxl-8">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h6 class="mb-0">Last Activity Laundry</h6>
                        </div>
                        <div class="card-body scrollbar recent-activity-body-height ps-2">
                            @forelse ($transaksi_pegawai_laundry as $item)
                            <div class="row g-3 timeline timeline-primary timeline-past pb-card">
                                <div class="col-auto ps-4 ms-2">
                                    <div class="ps-2">
                                        <div class="icon-item icon-item-sm rounded-circle bg-200 shadow-none">
